...
name: doc-drift
description: >
  Detect stale documentation. Compares AGENTS.md, CLAUDE.md, README,
  CONTRIBUTING.md, and other docs against actual code to find outdated
  instructions, missing docs for new features, dead references, and
  inconsistencies. Run periodically or before shipping.
---
...
- **Assistant instruction files vs reality** - project-specific
  `AGENTS.md` or `CLAUDE.md` files that describe patterns the code no
  longer follows
