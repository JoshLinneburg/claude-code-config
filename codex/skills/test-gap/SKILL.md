...
Run these commands before analyzing coverage:
...
ask the user what base branch to use.

## Setup

### 1. Review the diff
Use the diff context to understand the scope. If the diff
...
- Read the project's `AGENTS.md`, `CLAUDE.md`, and `CONTRIBUTING.md` for
  test conventions
